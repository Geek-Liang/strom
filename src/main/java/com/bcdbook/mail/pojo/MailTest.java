...
public class MailTest {
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        // 发件人的账号
        props.put("mail.user", "bcdbook@163.com");
        // 访问SMTP服务时需要提供的密码
        props.put("mail.password", "li95287048");
...
//message.sett
        // 设置收件人
        InternetAddress to = new InternetAddress("lixian13149999@163.com");
