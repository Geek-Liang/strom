...
public interface EventService {
	 ...
	 * @return
	 */
	public String processEvent(Map<String, String> msg);
	 ...
	 * @return
	 */
	public String processSubscribeEvent(Map<String, String> msg);
	 ...
	 * @return
	 */
	public String processUnSubscribeEvent(Map<String, String> msg);
	 ...
	 * @return
	 */
	public String processSCANEvent(Map<String, String> msg);
	 ...
	 * @return
	 */
	public String processLOCATIONEvent(Map<String, String> msg);
	 ...
	 * @return
	 */
	public String processCLICKEvent(Map<String, String> msg);
	 ...
	 * @return
	 */
	public String processVIEWEvent(Map<String, String> msg);
